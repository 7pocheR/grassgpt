#!/bin/bash
#SBATCH --job-name=gpt2m_grass_lr2e3
#SBATCH --output=logs/%j_gpt2m_grass_lr2e3.out
#SBATCH --error=logs/%j_gpt2m_grass_lr2e3.err
...
# Phase 3: Grassmann + Gating at d=1024, LR=2e-3 (reduced from 8e-3)
...
torchrun --standalone --nproc_per_node=4 \
    train.py config/train_gpt2_medium_grassmann_gated_lr2e3.py

echo ""
echo "=== Training Complete ==="
echo "End time: $(date)"
echo "Checkpoint saved to: /net/scratch2/junyuren/nanoGPT-manifold/out-gpt2m-grass-gate-lr2e3/ckpt.pt"
