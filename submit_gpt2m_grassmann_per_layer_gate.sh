#!/bin/bash
#SBATCH --job-name=gpt2m_grass_plg
#SBATCH --output=logs/%j_gpt2m_grass_plg.out
#SBATCH --error=logs/%j_gpt2m_grass_plg.err
...
# Grassmann + Per-Layer Gating at d=1024
...
mkdir -p /net/scratch2/junyuren/nanoGPT-manifold/out-gpt2m-grass-perlayergate
...
torchrun --standalone --nproc_per_node=4 \
    train.py config/train_gpt2_medium_grassmann_per_layer_gate.py

echo ""
echo "=== Training Complete ==="
echo "End time: $(date)"
echo "Checkpoint saved to: /net/scratch2/junyuren/nanoGPT-manifold/out-gpt2m-grass-perlayergate/ckpt.pt"
