# Resume OpenWebText rank99 from checkpoint
# Continuing from step 10000
...
wandb_run_name = 'grassmann-6L-384d-rank99-resume'
...
# Grassmann config - rank99
use_grassmann = True
grassmann_phase = 'phase2.5'

grass_rank_c_attn = 96
grass_rank_mlp_fc = 48
