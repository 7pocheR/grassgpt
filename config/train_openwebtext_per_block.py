# OpenWebText Phase 2.5 - Per-Block Exact Matching
# Same architecture as Shakespeare: 6L x 384d (~10M params)
# Rank strategy: exact measured stable ranks and operator norms per layer
...
wandb_run_name = 'grassmann-6L-384d-per-block'
...
# Per-block configuration from Shakespeare baseline analysis
# c_attn: blocks 0-5
