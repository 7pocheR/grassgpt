# Small-scale GPT: QKV-only Grassmann, r=128 (25% of width)
...
# Output directory
out_dir = '/net/scratch2/junyuren/nanoGPT-manifold/out-small-qkv-grass-r128'
...
# Phase identifier
grassmann_phase = 'small_qkv_r128'
