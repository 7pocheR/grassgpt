# OpenWebText Phase 2.5 - Rank 95 (intermediate compression)
# Effective ranks from analysis: c_attn ~327, mlp.c_fc ~336
# Using rank 95 (~25% of full rank 384) for moderate regularization

# I/O
out_dir = '/net/scratch2/junyuren/nanoGPT-manifold/out-openwebtext-rank95'
eval_interval = 1000
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'grassmann-6L-384d-rank95'
...
# Grassmann config - Rank 95 (uniform, intermediate)
use_grassmann = True
grassmann_phase = 'phase2.5'

grass_rank_c_attn = 95      # ~25% of 384 (vs 326 effective)
grass_rank_mlp_fc = 95      # ~25% of 384 (vs 336 effective)
