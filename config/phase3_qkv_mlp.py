# Phase 3: QKV + MLP Expansion (c_attn + mlp.c_fc + attn.c_proj)
# Coverage: ~62% of parameters
# Test if benefits compose additively

out_dir = '/net/scratch2/junyuren/nanoGPT-manifold/out-phase3-qkv-mlp'
eval_interval = 500
eval_iters = 200
log_interval = 10
