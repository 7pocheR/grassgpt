...
# Reduced LR: 2e-3 (vs 8e-3 which was too aggressive)
...
grass_rank = 512  # 50% of n_embd (keep same as 8e-3 run)
grass_scale = 10.0  # Uniform x=10 scaling
grass_a = 1.0  # Identity-centered for non-skip layers
grass_b = 0.0
grass_lr = 2e-3  # Reduced from 8e-3 (4× lower, ~3.3× AdamW base)
...
out_dir = '/net/scratch2/junyuren/nanoGPT-manifold/out-gpt2m-grass-gate-lr2e3'
