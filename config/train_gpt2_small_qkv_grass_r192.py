# Small-scale GPT: QKV-only Grassmann, r=192 (37.5% of width)
...
# Output directory
out_dir = '/net/scratch2/junyuren/nanoGPT-manifold/out-small-qkv-grass-r192'
...
# Phase identifier
grassmann_phase = 'small_qkv_r192'
