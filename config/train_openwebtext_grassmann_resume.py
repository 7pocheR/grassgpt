# Resume OpenWebText stable_rank_x2 from checkpoint
# Continuing from step 9000
...
wandb_run_name = 'grassmann-6L-384d-stable-rank-x2-resume'
...
# Grassmann config - stable_rank_x2
use_grassmann = True
