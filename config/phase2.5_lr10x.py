# Phase 2.5 LR Sweep: 10× multiplier (.010)
# Base: stable_rank_x2 (r=48,20, scale=4.63,10.14)

out_dir = '/net/scratch2/junyuren/nanoGPT-manifold/out-phase2.5-lr10x'
eval_interval = 500
eval_iters = 200
log_interval = 10
